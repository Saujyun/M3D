...
class Bottleneck(nn.Module):
	...
	def __init__(self, inplanes, planes, stride=1, downsample=None):
		...
		self.conv2 = nn.Conv3d(planes, planes, kernel_size=(1, 3, 3), stride=(stride, stride, stride), padding=(0, 1, 1), bias=False)
		self.bn2 = nn.BatchNorm3d(planes)

		self.conv2_t = nn.Conv3d(planes, planes, kernel_size=(3, 1, 1), stride=(stride, stride, stride), padding=(1, 0, 0), bias=False)
...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, num_classes=1000, train=True):
		...
		self.conv1_t = nn.Conv3d(3, 64, kernel_size=(3, 1, 1), stride=(1, 2, 2), padding=(1, 0, 0), bias=False)
