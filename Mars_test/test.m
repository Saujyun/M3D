...
%video_feat_test = process_box_feat4(box_feature_test);
video_feat_test = process_box_feat(box_feature_test, track_test);
...
fprintf('mAP = %.4f, r1 = %.4f, r5 = %.4f, r10 = %.4f, r20 = %.4f\n', map, CMC(1), CMC(5), CMC(10), CMC(20));